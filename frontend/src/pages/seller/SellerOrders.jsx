  ...
  return (
    <div className="page-enter">
      ...
      {loading ? <div className="skeleton" style={{ height: '300px' }} /> : items.length === 0 ? (
        <div className="card empty-state"><h3>No orders yet</h3></div>
      ) : (
        <div className="card">
          <table className="data-table">
            <thead><tr><th>Order ID</th><th>Quantity</th><th>Total</th><th>Type</th><th>Status</th><th></th></tr></thead>
            <tbody>
              {items.map(o => {
                ...
                return (
                  <tr key={o.id}>
                    ...
                    <td><button className="btn btn-ghost btn-sm" onClick={() => navigate(`/seller/orders/${o.id}`)}>View</button></td>
                  </tr>
                );
              })}
            </tbody>
